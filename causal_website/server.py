...
def receive_data():
    ...
    #global display_object
    if session["step"] == 1:
        file_name = "object_property_specific_" + session["display_object"][session["step"] - 1] + "_"+str(session.get("obj_prop_no1"))
        # session["obj_prop_no"]=data["time"]
        # session.modified = True
        # file_name = "object_property_specific_"
    elif session["step"] == 2:
        file_name = "object_property_specific_" + session["display_object"][session["step"] - 1] + "_"+str(session.get("obj_prop_no2"))
    elif session["step"] == 3:
...
def record_time_step1():
    ...
    # global display_object
    if session["step"] == 1:
        file_name = "object_property_specific_" + session["display_object"][session["step"] - 1] + "_" + str(
...
def plan_causal():
    ...
    if session["step"] == 1:
        # global submit_causal_1
        plan_name = "plan_specific_" + session["display_object"][session["step"] - 1] + "_" + str(session["submit_causal_1"]) + "_"
    elif session["step"] == 2:
        # global submit_causal_2
        plan_name = "plan_specific_" + session["display_object"][session["step"] - 1] + "_" + str(session.get("submit_causal_2")) + "_"
        # file_name = "causal_specific_"
    elif session["step"] == 3:
        # global submit_causal_3
    ...
    if session["step"] == 2:
        ...
        return jsonify(a)
    if session["step"] == 3:
        b = website_plan(causal_path, causal_path, session["encoding"], session["display_object"], num=session.get("submit_causal_3"),obj_prop_num= session.get("obj_prop_no3"),
                         gen="near")
        ...
        c = website_plan(causal_path, causal_path, session["encoding"], session["display_object"], num=0,obj_prop_num= 0, gen="far")
